...
// test('тест асихронных экшенов', async () => {
//   const expectedResult = data;
//
//   jest.spyOn(api, 'getIngredients').mockResolvedValue({
...
//
// describe('тесты селекторов', () => {
//   test('получение ингредиентов без булок', () => {
...
//     });
//
//     const ingredientsWithoutBuns = withoutBuns(store.getState());
//
//     expect(ingredientsWithoutBuns).toEqual([
//       {
//         _id: "643d69a5c3f7b9001cfa0941",
//         name: "Биокотлета из марсианской Магнолии",
//         type: "main",
...
//     ])
//   });
//   test('получение ингредиентов всех', () => {
//     // создаем начальный стор, из которого будет получать данные
//     const store = configureStore({
//       reducer: {
//         burgerConstructor: reducer,
...
//     });
//
//     const ingredientsAll = allIngredients(store.getState());
//
//     expect(ingredientsAll).toEqual(mockIngredients)
//   });
//   test('получение статуса загрузки', () => {
//     // создаем начальный стор, из которого будет получать данные
//     const store = configureStore({
//       reducer: {
//         burgerConstructor: reducer,
...
//     });
//
//     const loading = areIngredientsLoading(store.getState());
//
